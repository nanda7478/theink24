...
?>
	...
	<div class="subcribe">
       ...
       <h3>अपने न्यूज़लेटर की सदस्यता लें</h3> 
			<!-- <h4><span>SUBSCRIBE TO</span> OUR NEWS LETTER</h4> -->
			</div>
			<div class="col-lg-7 newsletter_input">
			<form role="search" method="get" id="searchform"   class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
		        <input type="text" value="<?php echo get_search_query(); ?>" name="new-footer" id="news-footer" placeholder="अपना ईमेल पता दर्ज करें " required	 />
		        <input type="submit" id="searchsubmit" value="<?php echo esc_attr_x( 'भेजना ', 'submit button' ); ?>" />
			</form>
			</div>
		</div>
	</div>
