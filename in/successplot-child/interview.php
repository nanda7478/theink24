...
<div class="container">
				<h3 class="inner_home_headings"> सभी कहानियां  </h3><div class="taxonomy-description">
					<p> सभी कहानी की प्रेरणादायक, उत्थान कहानियां </p>
</div>			</div></div>
<div class="container">
 ...
 -->
		<?php if ( have_posts() ) : ?>
			...
			<?php endwhile;	?>
              ...
              <div class="page_heading"><h3 class="home_heading"> ज्यादा कहानियां </h3></div>
              <div class="row" id="ajax-posts">
            <?php $args = array( 'post_type' => 'interviews', 'posts_per_page' => 3, 'offset' => 4  );
			$loop = new WP_Query( $args );
			while ( $loop->have_posts() ) : $loop->the_post(); ?>
