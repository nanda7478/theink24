		...
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="fresh-single">
					<div class="page_heading-fresh-left text-left"><a href="<?php echo site_url(); ?>/share-story">#Share Your Story</a> </div>
					<div class="page_heading-fresh-right text-right"><a href="<?php echo site_url(); ?>/share-start-up-story">#Share Start Up Story</a></div>	
							...
							?>
			                    ...
			                    <div class="post_details">
								 ...
								 <div class="date_time readmore-fresh">
								 		<a class="slider-left-box-a" href="<?php echo site_url(); ?>/interviews_category/fresh-basket">Read More Fresh Story</a>
								 	</div>					
...
<div class="container">
				...
				<div class="page_heading heading-border"><h3 class="home_heading">FEATURED STORIES </h3> <span class="page_heading-see-all"><a href="<?php echo site_url(); ?>/all-stories">See All</a> </span></div>
			...
			<!-- FEATURED STORIES  End-->
                        ...
                        <div class="story-section latest-story">
                        	<div class="page_heading heading-border"><h3 class="home_heading">LATEST STORIES </h3> <span class="page_heading-see-all"><a href="<?php echo site_url(); ?>/all-stories">See All</a> </span></div>
								<div class="row">
...
<div class="edit_pick_secton">	
	      <div class="page_heading heading-border"><h3 class="home_heading">EDITOR'S CHOICE </h3> </div>
								...
								<div class="edit_box_left col-lg-4">
									...
									<div class="user_date"><span class="display-inline-block"><i class="fa fa-user" aria-hidden="true"></i>
                                     ...
                                     <div class="post_para">
												...
												<div class="read-more"><a class="Read_More" href="<?php the_permalink($id_first); ?>">Read More</a></div>
                                    ...
                                    <div class="post-share-icon">
                                     ...
                                     <div class="post_para"> 
                                     		<div class="fix-align">	<?php $post_object = get_post( $id_second );
												...
												<div class="read-more"><a class="Read_More" href="<?php the_permalink($id_second); ?>">Read More</a></div>
                                    ...
                                    <div class="post-share-icon">
                                     ...
                                     <div class="post_para"><div class="fix-align"> <?php $post_object = get_post( $id_third );
                								$trimmed =  $post_object->post_content;
                								echo $trimmed_cont = wp_trim_words( $trimmed, 22, NULL ); ?></div>
												<div class="read-more"><a class="Read_More" href="<?php the_permalink($id_third); ?>">Read More</a></div>
...
<!-- custom editor end -->
                    ...
                    <div class="life-quot">Picture Quotes - Share our beautiful quote <a href="">Facebook,</a><a href="">Twitter,</a><a href="">Google+,</a> and Pinterest. <a href="<?php echo site_url(); ?>/life-quote"> More Picture -> </a> </div>
				<ul>
        	...
        	<div class="story-section">
                <div class="page_heading heading-border"><h3 class="home_heading">Blog and NEWS </h3> <span class="page_heading-see-all"><a href="<?php echo site_url(); ?>/blog">See All</a> </span></div>
			<div class="row">
				<?php
