							...
							?>
			                    ...
			                    <div class="post_details">
								 ...
								 <div class="date_time readmore-fresh">
								 		<a href="<?php echo site_url(); ?>/interviews_category/fresh-basket">Read More Fresh Story</a>
								 	</div>					
	...
	<!--<aside id="secondary" class="sidebar widget-area" role="complementary">-->
		<section class="widget widget_nav_menu side_scton" id="nav_menu-3">
				 ...
				 <ul class="nav nav-pills">
				    <li class="active"><a data-toggle="pill" href="#recent">Recent Posts</a></li>
				    <li><a data-toggle="pill" href="#popular">Popular Posts</a></li>
				  </ul>
				    ...
				    <div class="tab-content">
						...
						<?php
						    $recent_posts = wp_get_recent_posts(array('post_status'=>'publish','post_type'=>'post', 'posts_per_page' => 3 ));
					 ...
					 <?php
					    global $post;
					    $args = array( 'orderby' => 'comment_count','numberposts' => 3, 'post_type' => 'post' );
