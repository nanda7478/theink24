...
_atrk_opts = { atrk_acct:"EXMNp1IWh9106C", domain:"theink24.com",dynamic: true};
...
<!-- End Alexa Certify Javascript -->  
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-138601001-1"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());

	  gtag('config', 'UA-138601001-1');
	</script>
</head>
