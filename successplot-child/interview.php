...
<div class="container">
				<h3 class="inner_home_headings">All Stories</h3><div class="taxonomy-description"><p>Inspiring, uplifting stories of Artist Story</p>
</div>			</div></div>
<div class="container">
 ...
 -->
		<?php if ( have_posts() ) : ?>
			...
			<?php endwhile;	?>
              ...
              <div class="page_heading"><h3 class="home_heading">More Stories</h3></div>
              <div class="row" id="ajax-posts">
            <?php $args = array( 'post_type' => 'interviews', 'posts_per_page' => 6, 'offset' => 4  );
			$loop = new WP_Query( $args );
			while ( $loop->have_posts() ) : $loop->the_post(); ?>
		...
		<div class="laod-more text-center"><a class="load-more-buuton " id="more_posts">Load More</a></div>
